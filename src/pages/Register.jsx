...
import { UserPlus, Eye, EyeOff, ShieldCheck, GitBranch, Clock } from 'lucide-react';
...
const Register = () => {
  ...
  const [formState, formAction, isPending] = useActionState(async (prevState, formData) => {
    ...
    return { error: resultAction.payload || 'Registration failed. Please try again.' };
  }, { error: null });
  ...
  return (
    <div className="flex min-h-screen font-sans bg-[#09090b]">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        <div className="absolute top-1/2 right-0 -translate-y-1/2 w-75 h-150 bg-violet-600/5 blur-[100px] pointer-events-none" />
        ...
        <div className="w-full max-w-105 relative z-10">
          ...
          <form action={formAction} className="space-y-5">
            ...
            >
              {isPending ? 'Creating...' : <><UserPlus size={18} /> Create Account</>}
            </button>
          </form>
