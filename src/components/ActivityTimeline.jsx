        ...
        <div className="space-y-6 p-4">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex gap-3">
              <div className="h-8 w-8 rounded-full bg-slate-100 dark:bg-slate-800 shrink-0 animate-pulse" />
              <div className="space-y-2 flex-1">
                <div className="h-3 w-full bg-slate-100 dark:bg-slate-800/50 rounded animate-pulse" />
                <div className="h-2 w-24 bg-slate-50 dark:bg-slate-800/30 rounded animate-pulse" />
              </div>
            </div>
          ))}
        </div>
